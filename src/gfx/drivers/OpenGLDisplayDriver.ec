...
#if !defined(GFX_NO3D) && !defined(GFX_VANILLA)
...
public void * chooseGLXVisual(void * xGlobalDisplay, void ** fbConfigPtr, bool alphaBlend)
{
   ...
   if(fbConfigPtr) *fbConfigPtr = fbconfig;
#else
   ...
   visualInfo = glXChooseVisual(xGlobalDisplay, DefaultScreen(xGlobalDisplay), attrList);
   if(fbConfigPtr) *fbConfigPtr = null;
#endif
   return visualInfo;
#else
   return null;
...
#  if defined(__ANDROID__) || defined(__EMSCRIPTEN__) || defined(__ODROID__)
         ...
         result = true;
#  else
         XVisualInfo * visualInfo = display.xVisualInfo;
         GLXFBConfig fbConfig = display.glxFBConfig;
         /*
#if defined(__APPLE__)
