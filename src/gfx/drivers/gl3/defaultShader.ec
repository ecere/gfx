...
public class DefaultShader : Shader
{
   ...
   vertexShaderFile   = "data/gfx/shaders/default.vert";
   fragmentShaderFile = "data/gfx/shaders/default.frag";
#else
   vertexShaderFile   = "<:gfx>shaders/default.vert";
   fragmentShaderFile = "<:gfx>shaders/default.frag";
#endif
