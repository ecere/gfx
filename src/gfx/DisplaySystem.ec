...
public:
   ...
   ~DisplaySystem()
   {
#if !defined(GFX_VANILLA) && !defined(GFX_NO3D) && !defined(GFX_NOGL)
      OldLink mesh;
...
private:
   ...
   // REVIEW: How to pass this?
   public property void * xGlobalDisplay
   {
      set { xGlobalDisplay = value; }
      get { return xGlobalDisplay; }
   }
};
