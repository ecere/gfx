...
#if (defined(GFX_VANILLA) || defined(GFX_ONEDRIVER) || defined(GFX_NO3D)) && defined(__WIN32__)
...
#endif
            {
#if !defined(GFX_VANILLA) && !defined(GFX_NOGL)
